========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ChartViewer
========================================================================


AppWizard が生成した ChartViewer には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ChartViewer を構成している各ファイルの概要説明が含まれています。
...
ChartViewer.h
    ...
    みます） をインクルードし、また CChartViewerApp アプリケーションクラスを宣
    言します。

ChartViewer.cpp
    このファイルは CChartViewerApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ChartViewer.ico
    ...
    ルです。このアイコンはリソース ファイル ChartViewer.rc によってインクルード
    されます。
...
ChartViewerDlg.h, ChartViewerDlg.cpp - ダイアログ
    これらのファイルは CChartViewerDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な ChartViewer.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ChartViewer.pch 
