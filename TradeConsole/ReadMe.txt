========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : TradeConsole
========================================================================


AppWizard が生成した TradeConsole には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには TradeConsole を構成している各ファイルの概要説明が含まれています。
...
TradeConsole.h
    ...
    みます） をインクルードし、また CTradeConsoleApp アプリケーションクラスを宣
    言します。

TradeConsole.cpp
    このファイルは CTradeConsoleApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\TradeConsole.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル TradeConsole.rc によってインクルード
    されます。

res\TradeConsole.rc2
...
TradeConsoleDlg.h, TradeConsoleDlg.cpp - ダイアログ
    これらのファイルは CTradeConsoleDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な TradeConsole.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) TradeConsole.pch 
