========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : AutoTrader
========================================================================


AppWizard が生成した AutoTrader には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには AutoTrader を構成している各ファイルの概要説明が含まれています。
...
AutoTrader.h
    ...
    みます） をインクルードし、また CAutoTraderApp アプリケーションクラスを宣
    言します。

AutoTrader.cpp
    このファイルは CAutoTraderApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\AutoTrader.ico
    ...
    ルです。このアイコンはリソース ファイル AutoTrader.rc によってインクルード
    されます。
...
AutoTraderDlg.h, AutoTraderDlg.cpp - ダイアログ
    これらのファイルは CAutoTraderDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な AutoTrader.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) AutoTrader.pch 
