========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : TradeHelper
========================================================================


AppWizard が生成した TradeHelper には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには TradeHelper を構成している各ファイルの概要説明が含まれています。
...
TradeHelper.h
    ...
    みます） をインクルードし、また CTradeHelperApp アプリケーションクラスを宣
    言します。

TradeHelper.cpp
    このファイルは CTradeHelperApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\TradeHelper.ico
    ...
    ルです。このアイコンはリソース ファイル TradeHelper.rc によってインクルード
    されます。
...
TradeHelperDlg.h, TradeHelperDlg.cpp - ダイアログ
    これらのファイルは CTradeHelperDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な TradeHelper.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) TradeHelper.pch 
