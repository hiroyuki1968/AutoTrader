========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : RandChart
========================================================================


AppWizard が生成した RandChart には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには RandChart を構成している各ファイルの概要説明が含まれています。
...
RandChart.h
    ...
    みます） をインクルードし、また CRandChartApp アプリケーションクラスを宣
    言します。

RandChart.cpp
    このファイルは CRandChartApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\RandChart.ico
    ...
    ルです。このアイコンはリソース ファイル RandChart.rc によってインクルード
    されます。
...
RandChartDlg.h, RandChartDlg.cpp - ダイアログ
    これらのファイルは CRandChartDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な RandChart.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) RandChart.pch 
